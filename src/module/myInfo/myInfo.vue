<template>
  <div>
    ...
    <div class="group">
      <my-group v-for="i in group" :linkUrl.sync="i.url" :groupImg.sync="i.icon" :name.sync="i.name" :key="i.id"></my-group>
    </div>
  </div>
</template>
<script>
  ...
  export default {
      data(){
        return {
            userInfo:{
              userBack:'./images/beiJing.png',
              userAvatar:'./images/touXiang.png',
              userNickname:'小箭头',
              userCoin:'100',
              collection:'20',
              collectionUrl:'http://www.baidu.com'
            },
          functional:[
            {
