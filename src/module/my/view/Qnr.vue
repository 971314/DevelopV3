...
.icon-radio {
  ...
  width: 14px;
  height: 14px;
  background-image: url(../../../assets/images/radio1.png);
...
.qnr .qnr-group .icon + .icon {
  margin-top: 17px;
}
.qnr .qnr-group .icon:after {
  clear: both;
  display: table;
  content: " ";
}
.qnr .qnr-group .icon .icon-radio {
  float: left;
}
.qnr .qnr-group .icon span {
  float: left;
  width: calc(100% - 25px);
}
.qnr .footer {
...
.qnr .footer .btn-thirdly:disabled {
